...
APPS = [
    ...
    "journal", "birthday", "car", "chores", "pantry", "plant", "hours", "timezone", "breathe", "mood", "scan", "sun", "school", "shift", "boxes", "gift", "vitals", "workout", "fuel", "trip", "resume",
]
...
def build_og(path):
    ...
    d.text(
        (left, py1 + 46),
        "Fifty Android utilities that each do one thing.",
