...
APPS = [
    ...
    "journal", "birthday", "car", "chores", "pantry", "plant", "hours", "timezone", "breathe", "mood", "scan", "sun", "school", "shift", "boxes", "gift", "vitals", "workout", "fuel",
]
...
def build_og(path):
    ...
    d.text(
        (left, py1 + 46),
        "Forty-eight Android utilities that each do one thing.",
